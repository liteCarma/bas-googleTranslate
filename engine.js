function gtranslate() {
  ...
  var googleTranslate = {
    ...
    translate: function () {
      var textGTranslate = _function_argument('text')
      var optsGTranslate = _function_argument('opts') || {}
      optsGTranslate.from = optsGTranslate.from || 'auto';
      optsGTranslate.to = optsGTranslate.to || 'en';
      optsGTranslate.tld = optsGTranslate.tld || 'com';
      [optsGTranslate.from, optsGTranslate.to].forEach(function (lang) {
        if (lang &&!googleTranslate.languagesIsSupported(lang)) {
          fail_user('The language \'' + lang + '\' is not supported', true)
        }
      });
      optsGTranslate.from = googleTranslate.languagesGetCode(optsGTranslate.from);
      optsGTranslate.to = googleTranslate.languagesGetCode(optsGTranslate.to);
      var url = 'https://translate.google.' + optsGTranslate.tld;
      ...
      var data = 'f.req=' + encodeURIComponent(JSON.stringify([
        [
          [
            'MkEWBc',
            JSON.stringify([
              [textGTranslate, optsGTranslate.from, optsGTranslate.to, true],
              [null]
            ]),
            null,
            'generic'
